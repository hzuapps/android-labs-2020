...
public class Sec1814080911230Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnOpen = (Button) findViewById(R.id.wk1);
        View view = findViewById(R.id.wk1);
        ...
        Button btnOpen1 = (Button) findViewById(R.id.wk2);
        View view1 = findViewById(R.id.wk2);
