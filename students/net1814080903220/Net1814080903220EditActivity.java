...
public class Net1814080903220EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText editText1 = (EditText) findViewById(R.id.E_dit2);
        ...
        mBtnShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Net1814080903220EditActivity.this, Net1814080903220MainActivity.class);
                String massage = editText.getText().toString();
                String massage1 = editText1.getText().toString();
                intent.putExtra("data", massage);
                intent.putExtra("data1", massage1);
                startActivity(intent);
            }
        });
