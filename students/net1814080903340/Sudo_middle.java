...
public class Sudo_middle extends View {
    private String STR = "580000637000000000603540000"
            + "090104705010709040807205090" + "000026304000000000468000072";
    ...
    public Sudo_middle(Context context) {
        super(context);
        mContext = context;
        getUsedArray();
    }
