...
public class FileDownloadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String IMAGE_URL_PREFIX = "https://i0.hdslb.com/bfs/album/2fde5a42e6d08ae521706dd814b18a37f8b098e3.jpg@518w.jpg";
    ...
    private void downloadImages() {
        ...
        mFileDownloader = new FileDownloader(new FileDownloader.OnImageDownloadListener() {
            ...
            public void onError(String error) {
                Toast.makeText(FileDownloadActivity.this, error, Toast.LENGTH_SHORT).show();
            }
