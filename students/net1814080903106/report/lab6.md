...
​		本次实验学习Android上的网络编程,自己的项目里没有用到网络编程的内容，所以本次实验尝试调试课上代码内容，通过本次实验的学习对Android网络访问方法有一定的了解，本次实验的难度还是很大，花了很多时间去读懂代码。
